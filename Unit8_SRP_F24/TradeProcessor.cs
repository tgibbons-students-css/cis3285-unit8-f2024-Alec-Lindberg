...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private void StoreTrades(IEnumerable<TradeRecord> trades)
        {
            ...
            string alecConnectionString = @"Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\alindberg1\\source\\repos\\cis3285-unit8-f2024-Alec-Lindberg\\Unit8_SRP_F24\\DataFiles\\tradedatabase.mdf;Integrated Security=True;Connect Timeout=30";

            // Change the connection string used to match the one you want
            using (var connection = new SqlConnection(alecConnectionString))
            {
